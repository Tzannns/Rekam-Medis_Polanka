...
@section('title', 'Data Antrian - DataTables')
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('antrian.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                <i class="fas fa-plus fa-sm text-white-50"></i> Tambah Antrian
            </a>
        </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Daftar Antrian dengan DataTables</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="antrian-table" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>No Antrian</th>
            ...
            if (confirm('Apakah Anda yakin ingin menghapus antrian ini?')) {
                $.ajax({
                    ...
                    success: function(response) {
                        $('#antrian-table').DataTable().ajax.reload();
